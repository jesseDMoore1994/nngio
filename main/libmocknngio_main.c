...
void libnngio_mock_set_send_async_result(int result) { forced_send_async_result = result; }
void libnngio_mock_set_recv_async_result(int result) { forced_recv_async_result = result; }

void libnngio_mock_set_recv_buffer(const void *buf, size_t len) {
    size_t copy_len = len < sizeof(mock_recv_buffer) ? len : sizeof(mock_recv_buffer);
